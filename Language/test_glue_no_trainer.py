...
def main(args, seed, temp_dir):
    ...
    if not collected_data:
        ...
        eval_dataset = processed_datasets[test_name_mapping[args.eval_name]] if args.eval_name is not None \
                    else processed_datasets["validation_matched" if args.task_name == "mnli" else "validation"]
    else:
